...
NEUES TERMINAL ALS ADMIN AUSFÜHREN (am PC selbst):
net start MongoDB
...
dann noch bitte:
auf users gehen, dann steht dort INDEXES das anclicken und einen neuen Index erstellen, das ist damit man nicht doppelte Usernames hat:
